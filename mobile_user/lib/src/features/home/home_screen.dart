            ...
            child: Column(
              ...
              children: [
                ...
                const _NotificationRow(
                  ...
                  title: 'Scan to rent segera hadir',
                  subtitle: 'Untuk sementara, sewa sepeda masih lewat daftar.',
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [
          _DashboardPage(key: _dashboardKey, api: widget.api),
          ...
          const _ComingSoonPage(
            ...
            title: 'Scan to rent',
            message: 'Alur pemindaian QR sedang disiapkan.',
          ),
          HistoryScreen(
            key: _historyKey,
            api: widget.api,
...
class _DashboardPage extends StatefulWidget {
  const _DashboardPage({required this.api, super.key});
      ...
      child: ListView(
        ...
        children: [
          ...
          const _SectionHeader(
            ...
            subtitle: 'Sementara sampai scan to rent aktif',
          ),
          const SizedBox(height: 12),
          if (_bikes.isEmpty)
            const _EmptyState()
      ...
      children: [
        ...
        Text(
          hasActiveRental
              ...
              : '$bikeCount sepeda siap digunakan dari daftar sementara.',
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Mulai dari daftar sepeda di bawah.',
